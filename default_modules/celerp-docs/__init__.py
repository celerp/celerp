...
PLUGIN_MANIFEST = {
    ...
    "slots": {
        "nav": [
            {"group": "Sales Documents", "key": "invoices", "href": "/docs?type=invoice", "label": "Invoices", "label_key": "nav.invoices", "order": 20, "settings_href": "/settings/sales", "permission": "view_documents"},

...
def test_to_base_clean_conversion():
    from celerp.services.money import to_base
    # 100 USD * 35 THB/USD = 3500 THB
    result = to_base(100.0, D("35"), "THB")

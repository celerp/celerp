...
# Every /settings/* route requires an authenticated user. The kernel binds this
# router at 0.0.0.0, so an unauthenticated tier here is externally reachable;
# these endpoints manage cloud/integration state and read backup material, none
# of which is public. Privileged endpoints layer a business permission on top.

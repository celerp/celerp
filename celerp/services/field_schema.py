...
_BASE_FIELDS: list[dict] = [
    ...
    {"key": "gtin",              "label": "GTIN / UPC / EAN",  "type": "text",   "editable": True,  "required": False, "options": [],                                            "visible_to_roles": [],               "position": 104.1, "show_in_table": False, "tooltip_key": "field.tooltip.gtin", "label_key": "field.label.gtin"},
    {"key": "rfid_epc",          "label": "RFID / EPC",        "type": "text",   "editable": True,  "required": False, "options": [],                                            "visible_to_roles": [],               "position": 104.2, "show_in_table": False, "tooltip_key": "field.tooltip.rfid_epc", "label_key": "field.label.rfid_epc"},
